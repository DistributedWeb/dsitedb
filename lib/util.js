...
exports.checkoutVault = function (DWebVault, vault, version) {
  if (vault._vault && vault._loadPromise) {
    // probably dweb-vault, use this cheat method to solve the performance issue
  ...
  return new DWebVault(vault.url + '+' + version)
}
